...
class MovieListAdapter(
    val context: Context?, private val arrayList: ArrayList<MovieViewModel>,
    private val listener: (MovieViewModel, Int) -> Unit
) : RecyclerView.Adapter<MovieListAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        val packageBinding: ItemMovielistLayoutBinding =
            DataBindingUtil.inflate(layoutInflater, R.layout.item_movielist_layout, parent, false)
    ...
    class ViewHolder(private val packageBinding: ItemMovielistLayoutBinding) :
        ...
        fun bindItem(
            ...
            position: Int,
            listener: (MovieViewModel, Int) -> Unit
        ) {
